// function to conditionally create the about section
...
//function to handle the projects section 
const generateProjects = projectsArr => {

  //filter the projects onto an array that has conformation that a project is to be featured
  ...
  //filter all non-feature projects 
  ...
  //we take the array of featuredProjects and iterate through it, creating a new array from it
  ...
  // iterate through the non featured projects and create the html content for them
...
module.exports = templateData => {
  //destructuring the object templateData that contains the infromation from the user's input
